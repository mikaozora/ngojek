    ...
    <div class="kontainer">
        <div class="device">
            <div class="wrap-header">
                <div class="left">
                    <a href="mart.php"><img src="../assets/arrow-left.svg" alt=""></a>
                    <h3><?= $row["name"] ?></h3>
                </div>
                <div class="right">
                    <a href="cart.php">
                ...
                <div class="list-product">
                    ...
                    ?>
                        <div class="detail-product">
                            ...
                            <h6>Rp<?= number_format($row_menu["price"], 0, ',', '.') ?></h6>
                            <p><?= $row_menu["description"] ?></p>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <!-- <div class="modal-header">
                                        <h6 class="modal-title" id="staticBackdropLabel"><?= $row_menu["name"] ?></h6>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div> -->
                                    <form action="martDetail.php?mart=<?= $merchant_id ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="addToCart">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
