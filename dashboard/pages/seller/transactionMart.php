<?php
    ...
    $rows = mysqli_query($conn, "select * from order_item where merchant_id = '$logged_id'");
...
<body>
    <table class="table table-bordered bg-white">
        ...
        <tbody>
            <?php
            $no = 1;
            $sql = "SELECT oi.order_itemid, oi.transaction_date, c.name AS customer_name, d.name AS driver_name, oid.quantity, i.item_id, i.name AS product_name, i.price, (i.price * oid.quantity) AS total, SUM((i.price*oid.quantity)) AS grand_total, m.name as merchant_name FROM order_item oi 
            JOIN customers c ON oi.customer_id = c.customer_id
            JOIN driver d ON oi.driver_id = d.driver_id
            ...
            GROUP BY oi.order_itemid limit $start, $rowPerPage";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="kontainer-data">
                                    <?php
                                    $noDetail = 0;
                                    $sql_detail = "SELECT oi.order_itemid, oid.item_id, oid.quantity, i.name AS product_name, i.price, (i.price * oid.quantity) AS total FROM order_item oi
                                        JOIN order_item_detail oid ON oi.order_itemid = oid.order_itemid
                                        JOIN item i ON oid.item_id = i.item_id";
